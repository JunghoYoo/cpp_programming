...
{
	// 이동생성자
	Storage<int> storage(10000);
	Storage<int> storageCopy(std::move(storage));

	// 이동연산자
	Storage<char> storagea(10000, 'f');
	Storage<char> storageCopya(10000);
	storageCopya = std::move(storagea);
